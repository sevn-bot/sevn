...
Module: sevn.gateway.telegram_inline
Depends: typing, loguru, sevn.channels.telegram_capabilities,
    sevn.gateway.telegram_inline_types, sevn.gateway.telegram_inline_dispatch,
    sevn.gateway.telegram_inline_sources

Router + dispatch orchestration for Telegram inline updates. Shared value types
and config/auth helpers live in :mod:`sevn.gateway.telegram_inline_types`; pure
answer-assembly helpers in :mod:`sevn.gateway.telegram_inline_dispatch`. Both are
...
from sevn.gateway.telegram_inline_dispatch import (
...
from sevn.gateway.telegram_inline_types import (
...
async def dispatch_telegram_inline_query(
    ...
    *,
    ...
    from sevn.gateway.webapp_viewer import attach_inline_viewer_launch_buttons
