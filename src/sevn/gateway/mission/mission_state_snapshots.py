"""REST snapshot assembly for :class:`~sevn.gateway.mission.mission_state.MissionControlState`.

Module: sevn.gateway.mission.mission_state_snapshots
Depends: sevn.gateway.mission.mission_state_models
