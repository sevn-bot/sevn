...
Module: sevn.gateway.turn_bundle_hooks
Depends: asyncio, sevn.gateway.post_turn_hooks, sevn.gateway.turn_bundle
...
async def _post_turn_turn_bundle(ctx: PostTurnContext) -> None:
    ...
    if content_root is None or workspace is None:
        return
    from sevn.gateway.turn_bundle import effective_turn_bundles_enabled, write_turn_bundle
