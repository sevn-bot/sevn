...
Module: sevn.gateway.user_model_hooks
Depends: sevn.gateway.post_turn_hooks, sevn.gateway.user_model_turn
...
from sevn.gateway.post_turn_hooks import register_post_turn_hook
