...
def _telegram_config_dot_path_display(
    workspace: WorkspaceConfig,
    ...
    Examples:
        ...
        ...     },
        ... )
        >>> val = _telegram_config_dot_path_display(ws, {}, "agent.tier_b.model")
...
def _telegram_root_config_caption(
    ...
    if not sec.dot_paths:
        ...
        for path in sec.dot_paths:
            lines.append(f"{path}: {_telegram_config_dot_path_display(workspace, raw_doc, path)}")
    return "\n".join(lines)
