...
from sevn.gateway.menu_branding import (
...
class ConfigMenuHandler:
    ...
    async def handle(self, msg: IncomingMessage, *, session_id: str) -> None:
        ...
        if kind == "help":
            ...
            from sevn.gateway.menu_readiness import config_menu_level_help_text
...
def build_chat_menu_webapp_request(workspace: WorkspaceConfig) -> dict[str, Any]:
    ...
    Delegates to :func:`sevn.gateway.webapp_viewer.build_chat_menu_webapp_request`.
    ...
    Examples:
        ...
        'default'
    """
    from sevn.gateway.webapp_viewer import build_chat_menu_webapp_request as _build
...
async def sync_telegram_chat_menu_button(
    ...
    Delegates to :func:`sevn.gateway.webapp_viewer.sync_telegram_chat_menu_button`.
    ...
    Examples:
        ...
        True
    """
    from sevn.gateway.webapp_viewer import sync_telegram_chat_menu_button as _sync
