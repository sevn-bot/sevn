"""Gateway trace subscriber that feeds :class:`~sevn.gateway.mission_state.MissionControlState`.

Module: sevn.gateway.mission_trace_sink
Depends: sevn.agent.tracing.emit, sevn.gateway.mission_state, sevn.gateway.mission_state_models
...
Examples:
    ...
    >>> from sevn.gateway.mission_trace_sink import create_mission_trace_sink
...
def create_mission_trace_sink(state: MissionControlState) -> MissionControlTraceSink:
    ...
    Returns:
        ...
        :func:`~sevn.gateway.mission_trace_sink.detach_mission_trace_sink` on teardown.
    Examples:
        >>> from sevn.gateway.mission_state import MissionControlState
...
def resolve_mission_control_state(request: Request | None = None) -> Any:
    ...
    Returns:
        ...
        :class:`~sevn.gateway.mission_state.MissionControlState`.
