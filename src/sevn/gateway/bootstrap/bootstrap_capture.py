...
Module: sevn.gateway.bootstrap.bootstrap_capture
Depends: pathlib, re, sevn.gateway.onboarding.first_session, sevn.tools.workspace_files
...
def try_bootstrap_user_md_fallback(
    ...
    *,
    ...
    Examples:
        ...
        True
    """
    from sevn.gateway.onboarding.first_session import user_md_bootstrap_profile_incomplete
