...
Module: sevn.golden_llm.eval_runner
Depends: pydantic_evals, sevn.agent.tracing.otel_pipeline, sevn.golden_llm.dataset
...
from sevn.golden_llm.dataset import (
    GoldenCaseMetadata,
    build_golden_eval_dataset,
    ci_golden_case_ids,
)
from sevn.golden_llm.evaluators import GoldenRunOutput
