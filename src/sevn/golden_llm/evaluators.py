...
Module: sevn.golden_llm.evaluators
Depends: pydantic_evals, sevn.golden_llm.harness
...
if TYPE_CHECKING:
    from sevn.golden_llm.harness import GoldenCase, GoldenRecording
...
def optional_llm_judge_evaluator() -> Evaluator[str, GoldenRunOutput, dict[str, Any]] | None:
    ...
    Examples:
        ...
        True
    """
    from sevn.golden_llm.harness import golden_llm_live_enabled
...
def snapshot_from_recording(*, recording: GoldenRecording) -> dict[str, Any]:
    ...
    Examples:
        >>> from sevn.golden_llm.harness import GoldenRecording
