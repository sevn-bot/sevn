...
| media_generation | MiniMax media generation — image, video (text/i2v/templates), voice replication, music — via media_generator L2 specialist with prompt templates and trace metadata. |
