"""Canonical shared runtime for bundled Discogs skill scripts (D6/D7/D8/D11/D12).

Module: sevn.data.bundled_skills.core.discogs-shared.scripts._discogs_runtime
...
Exports:
    ...
    emit_json — write one JSON envelope to stdout.
"""
