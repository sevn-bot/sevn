#!/usr/bin/env python3
"""Bundled ``discogs-collection`` skill — remove a release from a collection folder.

Module: sevn.data.bundled_skills.core.discogs-collection.scripts.remove_release
