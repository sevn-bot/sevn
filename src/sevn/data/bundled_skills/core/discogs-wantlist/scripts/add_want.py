#!/usr/bin/env python3
"""Bundled ``discogs-wantlist`` skill — add a release to the wantlist.

Module: sevn.data.bundled_skills.core.discogs-wantlist.scripts.add_want
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--notes", help="Private notes for the want")
    parser.add_argument(
        "--notes-public",
        choices=("true", "false"),
