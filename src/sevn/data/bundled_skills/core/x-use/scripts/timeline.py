#!/usr/bin/env python3
"""Bundled ``x-use`` skill — home timeline snapshot.

Module: sevn.data.bundled_skills.core.x-use.scripts.timeline
...
from sevn.skills.social_browser import X_USE_SKILL_ID, dry_run_requested, fetch_page_snapshot


def main(argv: list[str] | None = None) -> int:
    """Return a visible-text snapshot of the X home timeline.
