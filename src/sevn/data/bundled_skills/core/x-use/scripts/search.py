#!/usr/bin/env python3
"""Bundled ``x-use`` skill — search snapshot.

Module: sevn.data.bundled_skills.core.x-use.scripts.search
...
def main(argv: list[str] | None = None) -> int:
    """Return a visible-text snapshot of an X search results page.
