...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "A recipe-goat-pp-cli subcommand line (e.g. 'foods search \"chicken "
            "breast\"'), tokenised on whitespace with quotes respected. Not free-text — "
            "see references/recipe_goat.md."
        ),
    )
    parser.add_argument(
        "args",
