#!/usr/bin/env python3
"""Bundled ``email-management`` skill — search messages.

Module: sevn.data.bundled_skills.core.email-management.scripts.search
...
def main(argv: list[str] | None = None) -> int:
    """Search messages by free-text query for one configured account.
    ...
    parser.add_argument("--query", required=True, help="Free-text search string.")
