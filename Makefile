...
ci-infra: config-schema onboarding-profiles-schema infra-check mission-control-schema-check check-git-guards check-compose-default sandbox-image-check agent-context-manifest-check storage-migration-rehearsal-check ## Schema / infra drift tier
...
CI_STEPS := lockcheck lint typecheck pyright test doctest security build artifact-integrity-check doctor-solutions-check \
	config-schema onboarding-profiles-schema infra-check mission-control-schema-check check-git-guards check-compose-default sandbox-image-check agent-context-manifest-check storage-migration-rehearsal-check \
