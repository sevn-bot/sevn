...
status: ready
owner: Alex
summary: A daily-driver AI must help you code—from repo Q&A and orientation through tier
  B quick fixes to tier C/D plans, workspace mirror, and PR workflows.
