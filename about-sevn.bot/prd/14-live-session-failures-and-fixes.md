...
status: draft
owner: Alex
summary: Catalog of real operator-session failures—grounding loops, PDF degradation, tool/skill
  routing—and the product fixes that stop silent hangs and fabricated answers.
