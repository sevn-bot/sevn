...
fingerprint: sha256:35b7a872a6c253011ae977d080c2e8eefc1af46171ed018377bc6d4e88ace45e
related: []
sources:
- src/sevn/**
...
Offline scaffold for Foundation — Spec (spec-00-foundation) — Purpose.

## Public Interface

Offline scaffold for Foundation — Spec (spec-00-foundation) — Public Interface.

## Data Model

Offline scaffold for Foundation — Spec (spec-00-foundation) — Data Model.

## Internal Architecture

Offline scaffold for Foundation — Spec (spec-00-foundation) — Internal Architecture.

## Behavior

Offline scaffold for Foundation — Spec (spec-00-foundation) — Behavior.

## Failure Modes

Offline scaffold for Foundation — Spec (spec-00-foundation) — Failure Modes.

## Test Strategy

Offline scaffold for Foundation — Spec (spec-00-foundation) — Test Strategy.
