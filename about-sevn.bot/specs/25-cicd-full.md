...
fingerprint: sha256:728220cbf3f33038f80464ccb9f090faddefef0ee9b3243d0d3796abe50bfb84
related: []
sources:
- src/sevn/**
- wave-orchestrator/**
...
- name: PlanMeta
  file: wave-orchestrator/spike/mode_b_spike.py
  symbol: PlanMeta
- name: cluster_lanes
  file: wave-orchestrator/spike/mode_b_spike.py
  symbol: cluster_lanes
- name: main
  file: wave-orchestrator/spike/mode_b_spike.py
  symbol: main
- name: round_trip
  ...
  symbol: round_trip
- name: Batch
  file: wave-orchestrator/spike/parse_dev_eval.py
  symbol: Batch
- name: Lane
  file: wave-orchestrator/spike/parse_dev_eval.py
  symbol: Lane
...
- name: WaveNode
  file: wave-orchestrator/spike/parse_dev_eval.py
  symbol: WaveNode
- name: build_run_graph
  file: wave-orchestrator/spike/parse_dev_eval.py
  symbol: build_run_graph
- name: main
  file: wave-orchestrator/spike/parse_dev_eval.py
  symbol: main
- name: print_graph
  ...
  symbol: print_graph
- name: build_adapter
  file: wave-orchestrator/src/waveorch/adapters/__init__.py
  symbol: build_adapter
- name: build_gate_adapter
  file: wave-orchestrator/src/waveorch/adapters/__init__.py
  symbol: build_gate_adapter
- name: get_adapter
  file: wave-orchestrator/src/waveorch/adapters/__init__.py
  symbol: get_adapter
- name: AdapterCapabilities
  file: wave-orchestrator/src/waveorch/adapters/base.py
  symbol: AdapterCapabilities
- name: AgentAdapter
  file: wave-orchestrator/src/waveorch/adapters/base.py
  symbol: AgentAdapter
- name: DispatchResult
  file: wave-orchestrator/src/waveorch/adapters/base.py
  symbol: DispatchResult
- name: run_streaming
  file: wave-orchestrator/src/waveorch/adapters/base.py
  symbol: run_streaming
- name: runaway_limits_from_env
  file: wave-orchestrator/src/waveorch/adapters/base.py
  symbol: runaway_limits_from_env
- name: ClaudeCodeAdapter
  file: wave-orchestrator/src/waveorch/adapters/claude_code.py
  symbol: ClaudeCodeAdapter
- name: collect_add_dirs
  file: wave-orchestrator/src/waveorch/adapters/claude_code.py
  symbol: collect_add_dirs
- name: resolve_add_dir
  file: wave-orchestrator/src/waveorch/adapters/claude_code.py
  symbol: resolve_add_dir
- name: CursorCloudAdapter
  file: wave-orchestrator/src/waveorch/adapters/cursor_cloud.py
  symbol: CursorCloudAdapter
- name: CursorLocalAdapter
  file: wave-orchestrator/src/waveorch/adapters/cursor_local.py
  symbol: CursorLocalAdapter
- name: resolve_cursor_cli
  file: wave-orchestrator/src/waveorch/adapters/cursor_local.py
  symbol: resolve_cursor_cli
- name: BackendOptions
  file: wave-orchestrator/src/waveorch/adapters/options.py
  symbol: BackendOptions
- name: resolve_role_dispatch
  file: wave-orchestrator/src/waveorch/adapters/options.py
  symbol: resolve_role_dispatch
- name: role_dispatch_from_env
  file: wave-orchestrator/src/waveorch/adapters/options.py
  symbol: role_dispatch_from_env
- name: is_quota_exhausted
  file: wave-orchestrator/src/waveorch/adapters/quota.py
  symbol: is_quota_exhausted
- name: quota_message
  file: wave-orchestrator/src/waveorch/adapters/quota.py
  symbol: quota_message
- name: stream_quota_pause
  file: wave-orchestrator/src/waveorch/adapters/quota.py
  symbol: stream_quota_pause
- name: summarize_stream_line
  file: wave-orchestrator/src/waveorch/adapters/stream_summary.py
  symbol: summarize_stream_line
- name: StreamUsage
  file: wave-orchestrator/src/waveorch/adapters/usage.py
  symbol: StreamUsage
- name: parse_stream_usage
  file: wave-orchestrator/src/waveorch/adapters/usage.py
  symbol: parse_stream_usage
- name: BatchTimelineData
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: BatchTimelineData
- name: BatchTimelineLane
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: BatchTimelineLane
- name: BatchTimelineNode
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: BatchTimelineNode
- name: LogPathError
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: LogPathError
- name: PauseBanner
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: PauseBanner
- name: build_batch_timeline
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: build_batch_timeline
- name: parse_escalation_reasons
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: parse_escalation_reasons
- name: read_log_file
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: read_log_file
- name: read_log_file_from_offset
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: read_log_file_from_offset
- name: read_pause_banners
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: read_pause_banners
- name: read_report_markdown
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: read_report_markdown
- name: render_report_markdown
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: render_report_markdown
- name: resolve_attempt_log_path
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: resolve_attempt_log_path
- name: sanitize_node_id_for_log
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: sanitize_node_id_for_log
- name: tail_log_file
  file: wave-orchestrator/src/waveorch/api/_artefacts.py
  symbol: tail_log_file
- name: require_auth
  file: wave-orchestrator/src/waveorch/api/_auth.py
  symbol: require_auth
- name: OrchestratorFeedEntry
  file: wave-orchestrator/src/waveorch/api/_orchestrator_ui.py
  symbol: OrchestratorFeedEntry
- name: OrchestratorPanelView
  file: wave-orchestrator/src/waveorch/api/_orchestrator_ui.py
  symbol: OrchestratorPanelView
- name: build_orchestrator_view
  file: wave-orchestrator/src/waveorch/api/_orchestrator_ui.py
  symbol: build_orchestrator_view
- name: parse_wave_node_from_turn
  file: wave-orchestrator/src/waveorch/api/_orchestrator_ui.py
  symbol: parse_wave_node_from_turn
- name: RunDetail
  file: wave-orchestrator/src/waveorch/api/_runs.py
  symbol: RunDetail
- name: RunSummary
  file: wave-orchestrator/src/waveorch/api/_runs.py
  symbol: RunSummary
- name: WorktreeStatus
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: WorktreeStatus
- name: WorktreeStatusError
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: WorktreeStatusError
- name: collect_worktree_status
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: collect_worktree_status
- name: load_staged_wave_plan_text
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: load_staged_wave_plan_text
- name: load_wave_plan_text_for_node
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: load_wave_plan_text_for_node
- name: resolve_wave_worktree_path
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: resolve_wave_worktree_path
- name: should_poll_worktree
  file: wave-orchestrator/src/waveorch/api/_worktree_status.py
  symbol: should_poll_worktree
- name: BackendOut
  file: wave-orchestrator/src/waveorch/api/app.py
  symbol: BackendOut
- name: ConfigIn
  file: wave-orchestrator/src/waveorch/api/app.py
  symbol: ConfigIn
...
- name: HitlAnswerIn
  file: wave-orchestrator/src/waveorch/api/app.py
  symbol: HitlAnswerIn
- name: HitlResponsesIn
  file: wave-orchestrator/src/waveorch/api/app.py
  symbol: HitlResponsesIn
- name: ProfileIn
  file: wave-orchestrator/src/waveorch/api/app.py
  symbol: ProfileIn
- name: ProfileOut
...
- name: create_app
  ...
  symbol: create_app
- name: fragment_url
  file: wave-orchestrator/src/waveorch/api/ui/router.py
  symbol: fragment_url
- name: log_append_url
  file: wave-orchestrator/src/waveorch/api/ui/router.py
  symbol: log_append_url
- name: log_fragment_url
  file: wave-orchestrator/src/waveorch/api/ui/router.py
  symbol: log_fragment_url
- name: log_full_page_url
  file: wave-orchestrator/src/waveorch/api/ui/router.py
  symbol: log_full_page_url
- name: make_ui_router
  file: wave-orchestrator/src/waveorch/api/ui/router.py
  symbol: make_ui_router
- name: extract_wave_summary
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: extract_wave_summary
- name: orchestrator_directives
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: orchestrator_directives
- name: render_dispatch_prompt
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: render_dispatch_prompt
- name: render_human_brief
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: render_human_brief
- name: render_json_brief
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: render_json_brief
- name: write_brief
  file: wave-orchestrator/src/waveorch/brief.py
  symbol: write_brief
- name: TurnBundleIndex
  file: wave-orchestrator/src/waveorch/build_plan_from_errors.py
  symbol: TurnBundleIndex
- name: TurnBundleIndexEntry
  file: wave-orchestrator/src/waveorch/build_plan_from_errors.py
  symbol: TurnBundleIndexEntry
...
- name: delete_run_cmd
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: delete_run_cmd
- name: init
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: init
- name: list_runs_cmd
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: list_runs_cmd
- name: main
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: main
- name: plan
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: plan
- name: pre0_interview_cmd
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: pre0_interview_cmd
- name: reset_run_cmd
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: reset_run_cmd
- name: resume
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: resume
- name: run
...
- name: validate
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: validate
- name: validate_plan_cmd
  file: wave-orchestrator/src/waveorch/cli.py
  symbol: validate_plan_cmd
- name: Engine
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: Engine
- name: GitWorktreeManager
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: GitWorktreeManager
- name: MakeVerifier
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: MakeVerifier
- name: NodeResult
...
- name: RunResult
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: RunResult
- name: SingleBranchWorktreeManager
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: SingleBranchWorktreeManager
- name: Verifier
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: Verifier
- name: WorktreeManager
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: WorktreeManager
- name: can_run_concurrently
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: can_run_concurrently
- name: complete_human_gate_waves
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: complete_human_gate_waves
- name: human_gate_node_ids
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: human_gate_node_ids
- name: nodes_for_batch
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: nodes_for_batch
- name: orchestrator_serial_nodes
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: orchestrator_serial_nodes
- name: ready_nodes
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: ready_nodes
- name: select_concurrent_set
  file: wave-orchestrator/src/waveorch/engine.py
  symbol: select_concurrent_set
- name: commit_and_push_wave
  file: wave-orchestrator/src/waveorch/git_commit.py
  symbol: commit_and_push_wave
- name: commit_msg_check
  file: wave-orchestrator/src/waveorch/git_commit.py
  symbol: commit_msg_check
- name: head_sha
  file: wave-orchestrator/src/waveorch/git_commit.py
  symbol: head_sha
- name: Batch
  file: wave-orchestrator/src/waveorch/graph.py
  symbol: Batch
- name: Lane
  file: wave-orchestrator/src/waveorch/graph.py
  symbol: Lane
...
- name: WaveNode
  file: wave-orchestrator/src/waveorch/graph.py
  symbol: WaveNode
- name: derive_forbidden_paths
  file: wave-orchestrator/src/waveorch/graph.py
  symbol: derive_forbidden_paths
- name: paths_overlap
  file: wave-orchestrator/src/waveorch/graph.py
  symbol: paths_overlap
- name: GateKind
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: GateKind
- name: HitlAnswer
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: HitlAnswer
...
- name: HitlResponses
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: HitlResponses
- name: PendingGate
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: PendingGate
- name: RunHitlContext
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: RunHitlContext
- name: approve_gate
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: approve_gate
- name: build_form
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: build_form
- name: build_options_for_gate
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: build_options_for_gate
- name: detect_pending_gate
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: detect_pending_gate
- name: gate_poll_ready
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: gate_poll_ready
- name: hitl_status
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: hitl_status
- name: load_form
...
- name: load_responses
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: load_responses
- name: load_run_hitl_context
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: load_run_hitl_context
- name: parse_decisions_table
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: parse_decisions_table
- name: responses_complete
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: responses_complete
- name: save_responses
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: save_responses
- name: validate_responses
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: validate_responses
- name: write_decisions_sheet
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: write_decisions_sheet
- name: write_form
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: write_form
- name: write_form_for_run
  file: wave-orchestrator/src/waveorch/hitl.py
  symbol: write_form_for_run
- name: BatchIntegration
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: BatchIntegration
- name: CommandRunner
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: CommandRunner
- name: GitMakeRunner
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: GitMakeRunner
- name: IntegrationError
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: IntegrationError
- name: IntegrationPlan
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: IntegrationPlan
- name: execute_integration
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: execute_integration
- name: plan_integration
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: plan_integration
- name: render_dry_run
  file: wave-orchestrator/src/waveorch/integrate.py
  symbol: render_dry_run
- name: AttemptRow
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: AttemptRow
- name: EventRow
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: EventRow
...
- name: append_event
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: append_event
- name: delete_attempts_for_node
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: delete_attempts_for_node
- name: end_attempt
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: end_attempt
- name: get_run
...
- name: insert_wave
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: insert_wave
- name: latest_events_by_node
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: latest_events_by_node
- name: list_attempts
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: list_attempts
- name: list_events
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: list_events
- name: list_waves
...
- name: open_ledger
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: open_ledger
- name: reset_wave_attempts
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: reset_wave_attempts
- name: transition_run
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: transition_run
- name: transition_wave
  file: wave-orchestrator/src/waveorch/ledger.py
  symbol: transition_wave
- name: format_terminal_summary
  file: wave-orchestrator/src/waveorch/log_format.py
  symbol: format_terminal_summary
- name: log_timestamp
  file: wave-orchestrator/src/waveorch/log_format.py
  symbol: log_timestamp
- name: stamp_log_line
  file: wave-orchestrator/src/waveorch/log_format.py
  symbol: stamp_log_line
- name: write_attempt_log_header
  file: wave-orchestrator/src/waveorch/log_format.py
  symbol: write_attempt_log_header
- name: load_hide_keys
  file: wave-orchestrator/src/waveorch/log_redact.py
  symbol: load_hide_keys
- name: redact_json_value
  file: wave-orchestrator/src/waveorch/log_redact.py
  symbol: redact_json_value
- name: redact_log_line
  file: wave-orchestrator/src/waveorch/log_redact.py
  symbol: redact_log_line
- name: redact_log_text
  file: wave-orchestrator/src/waveorch/log_redact.py
  symbol: redact_log_text
- name: validate_hide_keys_config
  file: wave-orchestrator/src/waveorch/log_redact.py
  symbol: validate_hide_keys_config
- name: GateDecision
  file: wave-orchestrator/src/waveorch/orchestrator_gate.py
  symbol: GateDecision
- name: dispatch_orchestrator_gate
  file: wave-orchestrator/src/waveorch/orchestrator_gate.py
  symbol: dispatch_orchestrator_gate
- name: parse_gate_result
  file: wave-orchestrator/src/waveorch/orchestrator_gate.py
  symbol: parse_gate_result
- name: OrchestratorSnapshot
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: OrchestratorSnapshot
- name: OrchestratorTurn
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: OrchestratorTurn
- name: StatusRow
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: StatusRow
- name: append_turn
...
- name: read_latest
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: read_latest
- name: render_status_table
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: render_status_table
- name: strip_backticks
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: strip_backticks
- name: sync_orchestrator_status
  file: wave-orchestrator/src/waveorch/orchestrator_status.py
  symbol: sync_orchestrator_status
- name: build_graph_from_dir
  file: wave-orchestrator/src/waveorch/parse/__init__.py
  symbol: build_graph_from_dir
- name: detect_mode
  file: wave-orchestrator/src/waveorch/parse/__init__.py
  symbol: detect_mode
- name: write_parallel_wave_manifest
  file: wave-orchestrator/src/waveorch/parse/manifest.py
  symbol: write_parallel_wave_manifest
- name: find_table_rows
  file: wave-orchestrator/src/waveorch/parse/markdown.py
  symbol: find_table_rows
- name: slice_section
  file: wave-orchestrator/src/waveorch/parse/markdown.py
  symbol: slice_section
- name: split_row
  file: wave-orchestrator/src/waveorch/parse/markdown.py
  symbol: split_row
- name: strip_md
  file: wave-orchestrator/src/waveorch/parse/markdown.py
  symbol: strip_md
- name: ParsedOrchestratorPrompt
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: ParsedOrchestratorPrompt
- name: WaveVerifyCommit
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: WaveVerifyCommit
- name: attach_orchestrator_config
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: attach_orchestrator_config
- name: build_orchestrator_config
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: build_orchestrator_config
- name: discover_orchestrator_prompt
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: discover_orchestrator_prompt
- name: parse_orchestrator_mode
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: parse_orchestrator_mode
- name: parse_orchestrator_prompt
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: parse_orchestrator_prompt
- name: parse_role_dispatch
  file: wave-orchestrator/src/waveorch/parse/orchestrator_prompt.py
  symbol: parse_role_dispatch
- name: build_run_graph
  file: wave-orchestrator/src/waveorch/parse/parallel_wave.py
  symbol: build_run_graph
- name: build_run_graph_from_dir
  file: wave-orchestrator/src/waveorch/parse/parallel_wave.py
  symbol: build_run_graph_from_dir
- name: PlanMeta
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: PlanMeta
- name: build_graph_mode_b
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: build_graph_mode_b
- name: cluster_lanes
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: cluster_lanes
- name: collect_pre0_gates_from_plans
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: collect_pre0_gates_from_plans
- name: generate_manifest
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: generate_manifest
- name: parse_plan_file
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: parse_plan_file
- name: read_review_hints
  file: wave-orchestrator/src/waveorch/parse/plan_files.py
  symbol: read_review_hints
- name: BatchSpec
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: BatchSpec
- name: WavePlanV1
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: WavePlanV1
- name: WaveSpec
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: WaveSpec
- name: build_graph_from_v1_dir
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: build_graph_from_v1_dir
- name: parse_wave_plan_v1
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: parse_wave_plan_v1
- name: validate_wave_plan_v1
  file: wave-orchestrator/src/waveorch/parse/wave_plan_v1.py
  symbol: validate_wave_plan_v1
- name: PlanPathValidationError
  file: wave-orchestrator/src/waveorch/pipeline.py
  symbol: PlanPathValidationError
- name: RunsRoot
  file: wave-orchestrator/src/waveorch/pipeline.py
  symbol: RunsRoot
- name: make_run_id
  file: wave-orchestrator/src/waveorch/pipeline.py
  symbol: make_run_id
- name: validate_wave_plans_in_dir
  file: wave-orchestrator/src/waveorch/pipeline.py
  symbol: validate_wave_plans_in_dir
- name: find_unresolved_refs
  file: wave-orchestrator/src/waveorch/plan_paths.py
  symbol: find_unresolved_refs
- name: format_plan_ref_errors
  file: wave-orchestrator/src/waveorch/plan_paths.py
  symbol: format_plan_ref_errors
- name: normalize_plan_refs
  file: wave-orchestrator/src/waveorch/plan_paths.py
  symbol: normalize_plan_refs
- name: suggest_plan_ref_fix
  file: wave-orchestrator/src/waveorch/plan_paths.py
  symbol: suggest_plan_ref_fix
- name: validate_plan
  file: wave-orchestrator/src/waveorch/plan_paths.py
  symbol: validate_plan
- name: DecisionOption
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: DecisionOption
- name: GateAnswer
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: GateAnswer
- name: RunContext
...
- name: interview_run
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: interview_run
- name: load_run_context
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: load_run_context
- name: parse_decisions_table
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: parse_decisions_table
- name: run_interview
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: run_interview
- name: write_decisions_sheet
  file: wave-orchestrator/src/waveorch/pre0_interview.py
  symbol: write_decisions_sheet
- name: ProfileRow
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: ProfileRow
- name: ProfileStore
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: ProfileStore
- name: control_plane_db_path
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: control_plane_db_path
- name: delete_profile
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: delete_profile
- name: get_profile
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: get_profile
- name: list_profiles
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: list_profiles
- name: open_profile_store
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: open_profile_store
- name: seed_default_profiles
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: seed_default_profiles
- name: upsert_profile
  file: wave-orchestrator/src/waveorch/profiles.py
  symbol: upsert_profile
- name: resolve_repo_root
  file: wave-orchestrator/src/waveorch/repo_root.py
  symbol: resolve_repo_root
- name: build_report
  file: wave-orchestrator/src/waveorch/report.py
  symbol: build_report
- name: sync_report
  file: wave-orchestrator/src/waveorch/report.py
  symbol: sync_report
- name: write_report
  ...
  symbol: write_report
- name: DispatchConfig
  file: wave-orchestrator/src/waveorch/run_dispatch.py
  symbol: DispatchConfig
- name: read_dispatch_config
  file: wave-orchestrator/src/waveorch/run_dispatch.py
  symbol: read_dispatch_config
- name: resolve_dispatch
  file: wave-orchestrator/src/waveorch/run_dispatch.py
  symbol: resolve_dispatch
- name: resume_cli_extra_argv
  file: wave-orchestrator/src/waveorch/run_dispatch.py
  symbol: resume_cli_extra_argv
- name: write_dispatch_config
  file: wave-orchestrator/src/waveorch/run_dispatch.py
  symbol: write_dispatch_config
- name: ScaffoldError
  file: wave-orchestrator/src/waveorch/scaffold.py
  symbol: ScaffoldError
- name: scaffold_package
  file: wave-orchestrator/src/waveorch/scaffold.py
  symbol: scaffold_package
- name: WaveTaskBullet
  file: wave-orchestrator/src/waveorch/wave_task.py
  symbol: WaveTaskBullet
- name: WaveTaskResult
  file: wave-orchestrator/src/waveorch/wave_task.py
  symbol: WaveTaskResult
- name: infer_active_task
  file: wave-orchestrator/src/waveorch/wave_task.py
  symbol: infer_active_task
- name: parse_wave_tasks
  file: wave-orchestrator/src/waveorch/wave_task.py
  symbol: parse_wave_tasks
- name: compute_workspace_scope
  file: wave-orchestrator/src/waveorch/workspace.py
  symbol: compute_workspace_scope
- name: Worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: Worktree
- name: WorktreeError
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: WorktreeError
- name: allocate_feature_branch_worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: allocate_feature_branch_worktree
- name: allocate_worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: allocate_worktree
- name: branch_name
...
- name: changed_paths
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: changed_paths
- name: checkpoint_message
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: checkpoint_message
- name: checkpoint_worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: checkpoint_worktree
- name: cleanup_run_worktrees
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: cleanup_run_worktrees
- name: cleanup_worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: cleanup_worktree
- name: detect_scope_breach
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: detect_scope_breach
- name: path_matches_owned
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: path_matches_owned
- name: recover_worktree
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: recover_worktree
- name: revert_breach
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: revert_breach
- name: stage_dispatch_context
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: stage_dispatch_context
- name: staged_wave_plan_path
  file: wave-orchestrator/src/waveorch/worktrees.py
  symbol: staged_wave_plan_path
- name: copy_dev_eval_input
  file: wave-orchestrator/tests/_dev_eval.py
  symbol: copy_dev_eval_input
- name: AlwaysFailVerifier
  file: wave-orchestrator/tests/_fakes.py
  symbol: AlwaysFailVerifier
- name: AlwaysPassVerifier
  file: wave-orchestrator/tests/_fakes.py
  symbol: AlwaysPassVerifier
- name: FakeAdapter
  file: wave-orchestrator/tests/_fakes.py
  symbol: FakeAdapter
- name: FakeWorktreeManager
  file: wave-orchestrator/tests/_fakes.py
  symbol: FakeWorktreeManager
- name: approve_run_with_hitl
  file: wave-orchestrator/tests/hitl_helpers.py
  symbol: approve_run_with_hitl
- name: complete_hitl_responses
  file: wave-orchestrator/tests/hitl_helpers.py
  symbol: complete_hitl_responses
- name: test_build_adapter_orchestrator_auto_model_for_cursor
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_build_adapter_orchestrator_auto_model_for_cursor
- name: test_build_adapter_orchestrator_wave_runner_and_model_policy
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_build_adapter_orchestrator_wave_runner_and_model_policy
- name: test_claude_add_dir_maps_files_to_parent_directories
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_add_dir_maps_files_to_parent_directories
- name: test_claude_argv_default_model
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_default_model
- name: test_claude_argv_exact
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_exact
- name: test_claude_argv_per_wave_model_overrides_default
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_per_wave_model_overrides_default
- name: test_claude_argv_skip_permissions
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_skip_permissions
- name: test_claude_argv_verbose_always_present
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_verbose_always_present
- name: test_claude_argv_with_model
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_argv_with_model
- name: test_claude_parse_result_done
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_parse_result_done
- name: test_claude_parse_result_failed_on_error_flag
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_parse_result_failed_on_error_flag
- name: test_claude_parse_result_timeout
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_claude_parse_result_timeout
- name: test_cursor_cloud_capabilities_reports_extra
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_cloud_capabilities_reports_extra
- name: test_cursor_cloud_no_argv
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_cloud_no_argv
- name: test_cursor_local_argv
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_local_argv
- name: test_cursor_local_argv_with_agent_wave_runner
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_local_argv_with_agent_wave_runner
- name: test_cursor_local_available
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_local_available
- name: test_cursor_local_unavailable
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_cursor_local_unavailable
- name: test_dispatch_orchestrator_gate_stubbed
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_dispatch_orchestrator_gate_stubbed
- name: test_fake_adapter_drives_to_done
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_fake_adapter_drives_to_done
- name: test_fake_adapter_fails_then_succeeds
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_fake_adapter_fails_then_succeeds
- name: test_get_adapter_unknown_raises
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_get_adapter_unknown_raises
- name: test_parse_gate_result_heuristics
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_parse_gate_result_heuristics
- name: test_registry_has_three_backends
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_registry_has_three_backends
- name: test_run_dry_run_prints_claude_argv
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_run_dry_run_prints_claude_argv
- name: test_run_streaming_echo
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_run_streaming_echo
- name: test_run_streaming_large_line
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_run_streaming_large_line
- name: test_summarize_stream_line_milestones
  file: wave-orchestrator/tests/test_adapters.py
  symbol: test_summarize_stream_line_milestones
- name: TestAgentTestInConfig
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestAgentTestInConfig
- name: TestAgentTestParsedFromPrompt
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestAgentTestParsedFromPrompt
- name: TestBriefAgentSelection
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestBriefAgentSelection
- name: TestNoOrchestratorAgentKey
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestNoOrchestratorAgentKey
- name: TestOrchestratorConfigAgentTest
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestOrchestratorConfigAgentTest
- name: TestParsedPromptAgentTest
  file: wave-orchestrator/tests/test_agent_selection.py
  symbol: TestParsedPromptAgentTest
- name: client
  file: wave-orchestrator/tests/test_api.py
  symbol: client
- name: client_authed
  file: wave-orchestrator/tests/test_api.py
  symbol: client_authed
- name: test_approve_run_409_when_hitl_incomplete
  file: wave-orchestrator/tests/test_api.py
  symbol: test_approve_run_409_when_hitl_incomplete
- name: test_approve_run_spawns_subprocess
  file: wave-orchestrator/tests/test_api.py
  symbol: test_approve_run_spawns_subprocess
- name: test_auth_200_correct_token
  file: wave-orchestrator/tests/test_api.py
  symbol: test_auth_200_correct_token
- name: test_auth_401_without_token
  file: wave-orchestrator/tests/test_api.py
  symbol: test_auth_401_without_token
- name: test_auth_401_wrong_token
  file: wave-orchestrator/tests/test_api.py
  symbol: test_auth_401_wrong_token
- name: test_create_agent_derived_id_collision_suffixes
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_agent_derived_id_collision_suffixes
- name: test_create_agent_derives_id_from_name
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_agent_derives_id_from_name
- name: test_create_agent_explicit_id_collision_409
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_agent_explicit_id_collision_409
- name: test_create_agent_honours_explicit_profile_id
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_agent_honours_explicit_profile_id
- name: test_create_and_get_agent
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_and_get_agent
- name: test_create_app_runs_root_anchored_at_repo_root
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_app_runs_root_anchored_at_repo_root
- name: test_create_app_runs_root_not_doubled_from_package_dir
  file: wave-orchestrator/tests/test_api.py
  symbol: test_create_app_runs_root_not_doubled_from_package_dir
- name: test_delete_agent
  file: wave-orchestrator/tests/test_api.py
  symbol: test_delete_agent
- name: test_get_agent_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_agent_404
- name: test_get_config_defaults
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_config_defaults
- name: test_get_hitl_returns_form
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_hitl_returns_form
- name: test_get_run_detail
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_run_detail
- name: test_get_run_detail_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_run_detail_404
- name: test_get_wave_detail
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_wave_detail
- name: test_get_wave_detail_404_node
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_wave_detail_404_node
- name: test_get_wave_detail_404_run
  file: wave-orchestrator/tests/test_api.py
  symbol: test_get_wave_detail_404_run
- name: test_health_no_auth_required_even_when_token_set
  file: wave-orchestrator/tests/test_api.py
  symbol: test_health_no_auth_required_even_when_token_set
- name: test_health_returns_200
  file: wave-orchestrator/tests/test_api.py
  symbol: test_health_returns_200
- name: test_hitl_submit_and_approve
  file: wave-orchestrator/tests/test_api.py
  symbol: test_hitl_submit_and_approve
- name: test_launch_run_400_missing_input_path
  file: wave-orchestrator/tests/test_api.py
  symbol: test_launch_run_400_missing_input_path
- name: test_launch_run_400_missing_profile
  file: wave-orchestrator/tests/test_api.py
  symbol: test_launch_run_400_missing_profile
- name: test_launch_run_spawns_subprocess
  file: wave-orchestrator/tests/test_api.py
  symbol: test_launch_run_spawns_subprocess
- name: test_list_agents_after_create
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_agents_after_create
- name: test_list_agents_empty
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_agents_empty
- name: test_list_backends
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_backends
- name: test_list_runs_empty
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_runs_empty
- name: test_list_runs_with_seeded_run
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_runs_with_seeded_run
- name: test_list_waves_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_waves_404
- name: test_list_waves_for_run
  file: wave-orchestrator/tests/test_api.py
  symbol: test_list_waves_for_run
- name: test_no_auth_mode_allows_all
  file: wave-orchestrator/tests/test_api.py
  symbol: test_no_auth_mode_allows_all
- name: test_patch_agent
  file: wave-orchestrator/tests/test_api.py
  symbol: test_patch_agent
- name: test_patch_agent_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_patch_agent_404
- name: test_pause_run_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_pause_run_404
- name: test_pause_run_writes_marker
  file: wave-orchestrator/tests/test_api.py
  symbol: test_pause_run_writes_marker
- name: test_poll_events_404
  file: wave-orchestrator/tests/test_api.py
  symbol: test_poll_events_404
- name: test_poll_events_after_all_returns_empty
  file: wave-orchestrator/tests/test_api.py
  symbol: test_poll_events_after_all_returns_empty
- name: test_poll_events_after_cursor
  file: wave-orchestrator/tests/test_api.py
  symbol: test_poll_events_after_cursor
- name: test_poll_events_returns_all
  file: wave-orchestrator/tests/test_api.py
  symbol: test_poll_events_returns_all
- name: test_profile_reuse_same_id_across_runs
  file: wave-orchestrator/tests/test_api.py
  symbol: test_profile_reuse_same_id_across_runs
- name: test_put_config_partial_update
  file: wave-orchestrator/tests/test_api.py
  symbol: test_put_config_partial_update
- name: test_put_config_updates_env
  file: wave-orchestrator/tests/test_api.py
  symbol: test_put_config_updates_env
- name: test_put_hitl_responses_saves_draft
  file: wave-orchestrator/tests/test_api.py
  symbol: test_put_hitl_responses_saves_draft
- name: test_resume_run_spawns_subprocess
  file: wave-orchestrator/tests/test_api.py
  symbol: test_resume_run_spawns_subprocess
- name: test_sse_stream_404_unknown_run
  file: wave-orchestrator/tests/test_api.py
  symbol: test_sse_stream_404_unknown_run
- name: test_sse_stream_id_field_present
  file: wave-orchestrator/tests/test_api.py
  symbol: test_sse_stream_id_field_present
- name: test_sse_stream_yields_seeded_events
  file: wave-orchestrator/tests/test_api.py
  symbol: test_sse_stream_yields_seeded_events
- name: test_submit_hitl_409_when_incomplete
  file: wave-orchestrator/tests/test_api.py
  symbol: test_submit_hitl_409_when_incomplete
- name: tmp_rr
  file: wave-orchestrator/tests/test_api.py
  symbol: tmp_rr
- name: client
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: client
- name: test_agents_list_page
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_agents_list_page
- name: test_api_wave_log_json
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_api_wave_log_json
- name: test_api_wave_log_json_no_attempts
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_api_wave_log_json_no_attempts
- name: test_api_worktree_json
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_api_worktree_json
- name: test_create_agent_form_post
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_create_agent_form_post
- name: test_edit_agent_form_post
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_edit_agent_form_post
- name: test_favicon_linked
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_favicon_linked
- name: test_launch_form_redirects
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_launch_form_redirects
- name: test_launch_form_renders
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_launch_form_renders
- name: test_log_append_returns_new_bytes
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_log_append_returns_new_bytes
- name: test_log_fragment_blocked_without_attempts_shows_deadlock_reason
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_log_fragment_blocked_without_attempts_shows_deadlock_reason
- name: test_log_fragment_no_attempts
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_log_fragment_no_attempts
- name: test_log_fragment_returns_tail
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_log_fragment_returns_tail
- name: test_nav_renders_on_pages
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_nav_renders_on_pages
- name: test_nav_renders_on_run_detail
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_nav_renders_on_run_detail
- name: test_orchestrator_fragment_returns_feed
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_orchestrator_fragment_returns_feed
- name: test_orchestrator_live_poll_trigger
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_orchestrator_live_poll_trigger
- name: test_orchestrator_panel_has_status_table_headers
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_orchestrator_panel_has_status_table_headers
- name: test_run_detail_hydrates_event_fields
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_hydrates_event_fields
- name: test_run_detail_includes_batch_timeline
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_includes_batch_timeline
- name: test_run_detail_includes_event_timeline
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_includes_event_timeline
- name: test_run_detail_shows_attempt_history
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_shows_attempt_history
- name: test_run_detail_shows_blocked_wave_failure_reasons
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_shows_blocked_wave_failure_reasons
- name: test_run_detail_shows_quota_pause_banner
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_shows_quota_pause_banner
- name: test_run_detail_shows_run_header
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_detail_shows_run_header
- name: test_run_header_shows_wave_summary_when_terminal
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_run_header_shows_wave_summary_when_terminal
- name: test_settings_form_get_and_post
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_settings_form_get_and_post
- name: test_sse_delivers_orchestrator_phase_event
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_sse_delivers_orchestrator_phase_event
- name: test_sse_payload_includes_attempt_n
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_sse_payload_includes_attempt_n
- name: test_tasks_fragment_renders_checklist
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_tasks_fragment_renders_checklist
- name: test_timeline_fragment_404_unknown
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_timeline_fragment_404_unknown
- name: test_timeline_fragment_returns_events
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_timeline_fragment_returns_events
- name: test_worktree_fragment_mocked_git
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_worktree_fragment_mocked_git
- name: test_worktree_fragment_shows_blocked_reason_without_worktree
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_worktree_fragment_shows_blocked_reason_without_worktree
- name: test_worktree_poll_stops_when_phase_done
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: test_worktree_poll_stops_when_phase_done
- name: tmp_rr
  file: wave-orchestrator/tests/test_api_ui.py
  symbol: tmp_rr
- name: rr
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: rr
- name: test_build_batch_timeline_from_graph_json
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_build_batch_timeline_from_graph_json
- name: test_log_filename_regex
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_log_filename_regex
- name: test_max_tail_bytes_is_200_kib
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_max_tail_bytes_is_200_kib
- name: test_parse_escalation_reasons
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_parse_escalation_reasons
- name: test_read_log_file_from_offset_appends
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_read_log_file_from_offset_appends
- name: test_read_pause_banners_quota
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_read_pause_banners_quota
- name: test_render_report_markdown_headings_and_lists
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_render_report_markdown_headings_and_lists
- name: test_resolve_attempt_log_path_happy
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_happy
- name: test_resolve_attempt_log_path_invalid_attempt
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_invalid_attempt
- name: test_resolve_attempt_log_path_missing_file
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_missing_file
- name: test_resolve_attempt_log_path_missing_run
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_missing_run
- name: test_resolve_attempt_log_path_processed_folder
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_processed_folder
- name: test_resolve_attempt_log_path_rejects_symlink
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_resolve_attempt_log_path_rejects_symlink
- name: test_sanitize_node_id_for_log
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_sanitize_node_id_for_log
- name: test_tail_log_file_reads_content
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_tail_log_file_reads_content
- name: test_tail_log_file_redacts_signature
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_tail_log_file_redacts_signature
- name: test_tail_log_file_truncates_large_file
  file: wave-orchestrator/tests/test_artefacts.py
  symbol: test_tail_log_file_truncates_large_file
- name: telemetry_node
  file: wave-orchestrator/tests/test_brief.py
  symbol: telemetry_node
- name: test_dispatch_prompt_uses_plan_worktree_path
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_dispatch_prompt_uses_plan_worktree_path
- name: test_human_brief_mentions_owned_and_forbidden
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_human_brief_mentions_owned_and_forbidden
- name: test_json_brief_forbids_cw_hotspots
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_json_brief_forbids_cw_hotspots
- name: test_json_brief_has_all_schema_keys
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_json_brief_has_all_schema_keys
- name: test_json_brief_lists_telemetry_owned
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_json_brief_lists_telemetry_owned
- name: test_retry_policy_escalates
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_retry_policy_escalates
- name: test_write_brief_creates_file
  file: wave-orchestrator/tests/test_brief.py
  symbol: test_write_brief_creates_file
- name: FakeBuildPlanAdapter
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: FakeBuildPlanAdapter
- name: safe_turn_id
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: safe_turn_id
- name: test_dispatch_prompt_references_problem_types
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_dispatch_prompt_references_problem_types
- name: test_dry_run_prints_dispatch_argv_and_does_not_dispatch
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_dry_run_prints_dispatch_argv_and_does_not_dispatch
- name: test_empty_folder_noop
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_empty_folder_noop
- name: test_makefile_dry_run_build_plan_from_errors_target
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_makefile_dry_run_build_plan_from_errors_target
- name: test_no_plan_when_all_clean
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_no_plan_when_all_clean
- name: test_processes_all_unprocessed_turns_and_flips_processed
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_processes_all_unprocessed_turns_and_flips_processed
- name: test_resolved_prompt_includes_problem_types_taxonomy
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_resolved_prompt_includes_problem_types_taxonomy
- name: test_single_plan_output_and_prompt_contains_all_error_turn_ids
  file: wave-orchestrator/tests/test_build_plan_from_errors.py
  symbol: test_single_plan_output_and_prompt_contains_all_error_turn_ids
- name: test_approve_missing_run_error
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_approve_missing_run_error
- name: test_approve_writes_marker
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_approve_writes_marker
- name: test_delete_run_cmd
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_delete_run_cmd
- name: test_init_creates_structure
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_init_creates_structure
- name: test_init_idempotent
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_init_idempotent
- name: test_list_runs_empty
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_list_runs_empty
- name: test_plan_missing_path_error
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_plan_missing_path_error
- name: test_plan_prints_run_id_and_batches
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_plan_prints_run_id_and_batches
- name: test_reset_run_restores_input_and_deletes_run
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_reset_run_restores_input_and_deletes_run
- name: test_resume_missing_ledger_error
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_resume_missing_ledger_error
- name: test_run_dry_run
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_run_dry_run
- name: test_run_integrate_dry_run
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_run_integrate_dry_run
- name: test_run_no_input_error
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_run_no_input_error
- name: test_status_all_empty
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_all_empty
- name: test_status_run_id_not_found
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_run_id_not_found
- name: test_status_seeded_run
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_seeded_run
- name: test_status_watch_renders_event_table
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_watch_renders_event_table
- name: test_status_watch_renders_orchestrator_awaiting_review
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_watch_renders_orchestrator_awaiting_review
- name: test_status_watch_requires_run_id
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_watch_requires_run_id
- name: test_status_watch_unknown_run
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_status_watch_unknown_run
- name: test_version_flag
  file: wave-orchestrator/tests/test_cli.py
  symbol: test_version_flag
- name: MarkingAdapter
  file: wave-orchestrator/tests/test_engine.py
  symbol: MarkingAdapter
- name: test_approve_then_resume_completes
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_approve_then_resume_completes
- name: test_blocked_run_keeps_worktree_and_commits
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_blocked_run_keeps_worktree_and_commits
- name: test_can_run_concurrently_both_late_cw_false
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_can_run_concurrently_both_late_cw_false
- name: test_can_run_concurrently_disjoint
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_can_run_concurrently_disjoint
- name: test_can_run_concurrently_overlap_false
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_can_run_concurrently_overlap_false
- name: test_dev_eval_e2e_pre0_then_processed
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_dev_eval_e2e_pre0_then_processed
- name: test_fifth_failure_escalates_to_failed
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_fifth_failure_escalates_to_failed
- name: test_make_verifier_toolchain_env
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_make_verifier_toolchain_env
- name: test_make_verifier_typecheck_scoped_on_real_worktree
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_make_verifier_typecheck_scoped_on_real_worktree
- name: test_quota_exhausted_pauses_run
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_quota_exhausted_pauses_run
- name: test_ready_nodes_respects_deps
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_ready_nodes_respects_deps
- name: test_resume_after_crash_skips_completed
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_resume_after_crash_skips_completed
- name: test_resume_resets_interrupted_waves
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_resume_resets_interrupted_waves
- name: test_retry_preserves_checkpointed_work
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_retry_preserves_checkpointed_work
- name: test_start_stops_at_pre0
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_start_stops_at_pre0
- name: test_verify_failure_escalates
  file: wave-orchestrator/tests/test_engine.py
  symbol: test_verify_failure_escalates
- name: OrderTrackingAdapter
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: OrderTrackingAdapter
- name: test_cost_pause_lets_siblings_finish
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_cost_pause_lets_siblings_finish
- name: test_dep_order_respected
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_dep_order_respected
- name: test_dependency_deadlock_escalates
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_dependency_deadlock_escalates
- name: test_disjoint_nodes_run_concurrently
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_disjoint_nodes_run_concurrently
- name: test_ledger_integrity_under_gather
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_ledger_integrity_under_gather
- name: test_overlapping_paths_run_serially
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_overlapping_paths_run_serially
- name: test_quota_pause_lets_siblings_finish
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_quota_pause_lets_siblings_finish
- name: test_select_concurrent_set_all_disjoint
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_select_concurrent_set_all_disjoint
- name: test_select_concurrent_set_empty
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_select_concurrent_set_empty
- name: test_select_concurrent_set_late_cw_excluded
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_select_concurrent_set_late_cw_excluded
- name: test_select_concurrent_set_overlapping_excluded
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_select_concurrent_set_overlapping_excluded
- name: test_select_concurrent_set_single
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_select_concurrent_set_single
- name: test_semaphore_limits_concurrency
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_semaphore_limits_concurrency
- name: test_single_node_still_works
  file: wave-orchestrator/tests/test_engine_concurrency.py
  symbol: test_single_node_still_works
- name: TestDeriveForbiddenRegressionGuard
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestDeriveForbiddenRegressionGuard
- name: TestDeriveForbiddenWithTestPaths
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestDeriveForbiddenWithTestPaths
- name: TestEmptyTestPaths
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestEmptyTestPaths
- name: TestGraphBuildTestPathOverlay
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestGraphBuildTestPathOverlay
- name: TestPathsOverlapWithTestDirs
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestPathsOverlapWithTestDirs
- name: TestTestPathsConstant
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestTestPathsConstant
- name: TestTestPathsOverlapWithOwned
  file: wave-orchestrator/tests/test_forbidden_test_paths.py
  symbol: TestTestPathsOverlapWithOwned
- name: test_batch_order
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_batch_order
- name: test_cw_hotspots_cover_five_seams
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_cw_hotspots_cover_five_seams
- name: test_derive_forbidden_cw_owner_excluded
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_derive_forbidden_cw_owner_excluded
- name: test_derive_forbidden_includes_other_lanes_and_cw
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_derive_forbidden_includes_other_lanes_and_cw
- name: test_derive_forbidden_single_lane_owns_cw_hotspots
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_derive_forbidden_single_lane_owns_cw_hotspots
- name: test_paths_overlap_disjoint
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_paths_overlap_disjoint
- name: test_paths_overlap_exact
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_paths_overlap_exact
- name: test_paths_overlap_not_substring_false
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_paths_overlap_not_substring_false
- name: test_paths_overlap_prefix
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_paths_overlap_prefix
- name: test_to_dict_round_trips_run_id
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_to_dict_round_trips_run_id
- name: test_validate_dangling_dep
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_dangling_dep
- name: test_validate_detects_cycle
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_detects_cycle
- name: test_validate_detects_overlap
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_detects_overlap
- name: test_validate_empty_graph_ok
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_empty_graph_ok
- name: test_validate_no_cycle_on_dag
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_no_cycle_on_dag
- name: test_validate_no_overlap_disjoint
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_no_overlap_disjoint
- name: test_validate_unknown_cw_seam
  file: wave-orchestrator/tests/test_graph.py
  symbol: test_validate_unknown_cw_seam
- name: test_approve_gate_requires_responses
  file: wave-orchestrator/tests/test_hitl.py
  symbol: test_approve_gate_requires_responses
- name: test_build_options_d1_gate
  file: wave-orchestrator/tests/test_hitl.py
  symbol: test_build_options_d1_gate
- name: test_form_generation_and_validation
  file: wave-orchestrator/tests/test_hitl.py
  symbol: test_form_generation_and_validation
- name: test_responses_complete_false_without_form
  file: wave-orchestrator/tests/test_hitl.py
  symbol: test_responses_complete_false_without_form
- name: test_human_gate_node_ids_from_batches
  file: wave-orchestrator/tests/test_human_gate_engine.py
  symbol: test_human_gate_node_ids_from_batches
- name: test_resume_after_pre0_skips_w0_and_dispatches_r1
  file: wave-orchestrator/tests/test_human_gate_engine.py
  symbol: test_resume_after_pre0_skips_w0_and_dispatches_r1
- name: FakeRunner
  file: wave-orchestrator/tests/test_integrate.py
  symbol: FakeRunner
- name: test_execute_gate_failure_raises_and_skips_commit
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_execute_gate_failure_raises_and_skips_commit
- name: test_execute_merge_order_and_one_commit_per_batch
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_execute_merge_order_and_one_commit_per_batch
- name: test_execute_no_commit_during_pre0
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_execute_no_commit_during_pre0
- name: test_plan_final_gate_commands
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_plan_final_gate_commands
- name: test_plan_human_gate_has_no_commit
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_plan_human_gate_has_no_commit
- name: test_plan_integration_branch_off_base
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_plan_integration_branch_off_base
- name: test_plan_merge_order_and_docs_menu
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_plan_merge_order_and_docs_menu
- name: test_render_dry_run_lines
  file: wave-orchestrator/tests/test_integrate.py
  symbol: test_render_dry_run_lines
- name: lc
  file: wave-orchestrator/tests/test_ledger.py
  symbol: lc
- name: test_end_attempt_records_run_cost
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_end_attempt_records_run_cost
- name: test_end_attempt_sets_outcome
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_end_attempt_sets_outcome
- name: test_end_attempt_with_evidence
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_end_attempt_with_evidence
- name: test_get_run_missing_raises
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_get_run_missing_raises
- name: test_get_wave_missing_raises
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_get_wave_missing_raises
- name: test_insert_attempt_increments_count
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_insert_attempt_increments_count
- name: test_insert_run_default_state
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_insert_run_default_state
- name: test_insert_wave_default_state
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_insert_wave_default_state
- name: test_latest_events_by_node_collapses_per_node
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_latest_events_by_node_collapses_per_node
- name: test_latest_events_by_node_empty_run
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_latest_events_by_node_empty_run
- name: test_list_attempts_order
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_list_attempts_order
- name: test_list_waves_ordering
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_list_waves_ordering
- name: test_open_ledger_creates_tables
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_open_ledger_creates_tables
- name: test_reset_wave_attempts_clears_rows
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_reset_wave_attempts_clears_rows
- name: test_retry_escalate_pattern
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_retry_escalate_pattern
- name: test_transition_run_active_to_done
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_transition_run_active_to_done
- name: test_transition_run_terminal_idempotent
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_transition_run_terminal_idempotent
- name: test_transition_run_terminal_to_different_raises
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_transition_run_terminal_to_different_raises
- name: test_wave_full_happy_path
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_wave_full_happy_path
- name: test_wave_gate_pending_state
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_wave_gate_pending_state
- name: test_wave_terminal_guard
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_wave_terminal_guard
- name: test_wave_terminal_idempotent
  file: wave-orchestrator/tests/test_ledger.py
  symbol: test_wave_terminal_idempotent
- name: test_format_terminal_summary
  file: wave-orchestrator/tests/test_log_format.py
  symbol: test_format_terminal_summary
- name: test_stamp_log_line_adds_timestamp
  file: wave-orchestrator/tests/test_log_format.py
  symbol: test_stamp_log_line_adds_timestamp
- name: test_write_attempt_log_header
  file: wave-orchestrator/tests/test_log_format.py
  symbol: test_write_attempt_log_header
- name: test_load_hide_keys_includes_signature
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_load_hide_keys_includes_signature
- name: test_redact_json_value_replaces_signature
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_redact_json_value_replaces_signature
- name: test_redact_log_line_json
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_redact_log_line_json
- name: test_redact_log_line_with_timestamp_prefix
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_redact_log_line_with_timestamp_prefix
- name: test_redact_log_text_multiline
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_redact_log_text_multiline
- name: test_validate_hide_keys_config_gate
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_validate_hide_keys_config_gate
- name: test_validate_hide_keys_config_rejects_missing_signature
  file: wave-orchestrator/tests/test_log_redact.py
  symbol: test_validate_hide_keys_config_rejects_missing_signature
- name: TestBriefRetryPolicy
  file: wave-orchestrator/tests/test_max_attempts.py
  symbol: TestBriefRetryPolicy
- name: TestEngineMaxAttemptsDefault
  file: wave-orchestrator/tests/test_max_attempts.py
  symbol: TestEngineMaxAttemptsDefault
- name: TestEngineMaxAttemptsOverride
  file: wave-orchestrator/tests/test_max_attempts.py
  symbol: TestEngineMaxAttemptsOverride
- name: TestEngineRetryLoop5Attempts
  file: wave-orchestrator/tests/test_max_attempts.py
  symbol: TestEngineRetryLoop5Attempts
- name: TestEscalationBannerParameterised
  file: wave-orchestrator/tests/test_max_attempts.py
  symbol: TestEscalationBannerParameterised
- name: test_ambiguous_text_fails_closed
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_ambiguous_text_fails_closed
- name: test_approve_to_continue
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_approve_to_continue
- name: test_approved_word
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_approved_word
- name: test_blocked_is_rejected
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_blocked_is_rejected
- name: test_changes_approved
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_changes_approved
- name: test_decision_approve_case_insensitive
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_approve_case_insensitive
- name: test_decision_approve_extra_whitespace
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_approve_extra_whitespace
- name: test_decision_approve_structured
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_approve_structured
- name: test_decision_approve_with_surrounding_text
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_approve_with_surrounding_text
- name: test_decision_stop_case_insensitive
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_stop_case_insensitive
- name: test_decision_stop_structured
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_stop_structured
- name: test_decision_stop_with_surrounding_text
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_decision_stop_with_surrounding_text
- name: test_disapprove_is_rejected
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_disapprove_is_rejected
- name: test_dispatch_w1
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_dispatch_w1
- name: test_do_not_approve_is_rejected
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_do_not_approve_is_rejected
- name: test_do_not_proceed_is_rejected
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_do_not_proceed_is_rejected
- name: test_empty_text_fails_closed
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_empty_text_fails_closed
- name: test_none_text_fails_closed
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_none_text_fails_closed
- name: test_plain_stop_lowercase
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_plain_stop_lowercase
- name: test_raw_text_preserved
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_raw_text_preserved
- name: test_reject_is_rejected
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_reject_is_rejected
- name: test_summary_is_first_line
  file: wave-orchestrator/tests/test_orchestrator_gate.py
  symbol: test_summary_is_first_line
- name: SummaryAdapter
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: SummaryAdapter
- name: test_dev_eval_orchestrator_e2e_pre0_then_processed
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_dev_eval_orchestrator_e2e_pre0_then_processed
- name: test_extract_wave_summary_first_h2
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_extract_wave_summary_first_h2
- name: test_orchestrator_directives_include_partial_ci
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_directives_include_partial_ci
- name: test_orchestrator_emits_ledger_phase_events
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_emits_ledger_phase_events
- name: test_orchestrator_gate_dispatch_auto_continue
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_gate_dispatch_auto_continue
- name: test_orchestrator_review_gate_pause
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_review_gate_pause
- name: test_orchestrator_serial_nodes_order
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_serial_nodes_order
- name: test_orchestrator_serial_run_status_turns
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_orchestrator_serial_run_status_turns
- name: test_render_dispatch_prompt_orchestrator_context
  file: wave-orchestrator/tests/test_orchestrator_mode_engine.py
  symbol: test_render_dispatch_prompt_orchestrator_context
- name: example_input
  file: wave-orchestrator/tests/test_orchestrator_mode_smoke.py
  symbol: example_input
- name: test_example_set_enables_orchestrator_config
  file: wave-orchestrator/tests/test_orchestrator_mode_smoke.py
  symbol: test_example_set_enables_orchestrator_config
- name: test_example_set_passes_validate
  file: wave-orchestrator/tests/test_orchestrator_mode_smoke.py
  symbol: test_example_set_passes_validate
- name: test_w0_status_table_parity_terminal_and_dashboard
  file: wave-orchestrator/tests/test_orchestrator_mode_smoke.py
  symbol: test_w0_status_table_parity_terminal_and_dashboard
- name: golden_prompt_path
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: golden_prompt_path
- name: test_discover_prefers_slug_match
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_discover_prefers_slug_match
- name: test_golden_build_orchestrator_config
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_build_orchestrator_config
- name: test_golden_dashboard_ui_feature_branch
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_dashboard_ui_feature_branch
- name: test_golden_dashboard_ui_partial_ci_verify
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_dashboard_ui_partial_ci_verify
- name: test_golden_dashboard_ui_reporting_columns
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_dashboard_ui_reporting_columns
- name: test_golden_dashboard_ui_review_gate
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_dashboard_ui_review_gate
- name: test_golden_dashboard_ui_wave_order
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_golden_dashboard_ui_wave_order
- name: test_orchestrator_mode_off_disables
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_orchestrator_mode_off_disables
- name: test_orchestrator_mode_serial_from_section
  file: wave-orchestrator/tests/test_orchestrator_prompt.py
  symbol: test_orchestrator_mode_serial_from_section
- name: test_append_turn_and_read_latest
  file: wave-orchestrator/tests/test_orchestrator_status.py
  symbol: test_append_turn_and_read_latest
- name: test_append_turn_increments_turn_number
  file: wave-orchestrator/tests/test_orchestrator_status.py
  symbol: test_append_turn_increments_turn_number
- name: test_graph_orchestrator_serializes_in_to_dict
  file: wave-orchestrator/tests/test_orchestrator_status.py
  symbol: test_graph_orchestrator_serializes_in_to_dict
- name: test_render_status_table_cursor_export_shape
  file: wave-orchestrator/tests/test_orchestrator_status.py
  symbol: test_render_status_table_cursor_export_shape
- name: test_sync_orchestrator_status_in_memory_turns_skip_disk_read
  file: wave-orchestrator/tests/test_orchestrator_status.py
  symbol: test_sync_orchestrator_status_in_memory_turns_skip_disk_read
- name: test_package_importable
  file: wave-orchestrator/tests/test_package.py
  symbol: test_package_importable
- name: dev_eval_graph
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: dev_eval_graph
- name: test_batch_order_matches_orchestrator
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_batch_order_matches_orchestrator
- name: test_build_run_graph_minimal
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_build_run_graph_minimal
- name: test_final_batch_has_gate_commands
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_final_batch_has_gate_commands
- name: test_graph_has_no_cycles_or_dangling
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_graph_has_no_cycles_or_dangling
- name: test_lanes_parsed
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_lanes_parsed
- name: test_pre0_gates_present
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_pre0_gates_present
- name: test_pre0_is_human_gate
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_pre0_is_human_gate
- name: test_telemetry_forbidden_includes_cw_hotspots
  file: wave-orchestrator/tests/test_parse_mode_a.py
  symbol: test_telemetry_forbidden_includes_cw_hotspots
- name: test_build_graph_from_dir_dispatches_to_mode_b
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_build_graph_from_dir_dispatches_to_mode_b
- name: test_build_graph_mode_b_generates_manifest
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_build_graph_mode_b_generates_manifest
- name: test_cluster_lanes_groups_overlapping
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_cluster_lanes_groups_overlapping
- name: test_detect_mode_b
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_detect_mode_b
- name: test_detect_mode_stays_b_for_generated_manifest
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_detect_mode_stays_b_for_generated_manifest
- name: test_mode_b_single_plan_uses_plan_pre0_not_dev_eval
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_mode_b_single_plan_uses_plan_pre0_not_dev_eval
- name: test_parse_files_in_scope_ignores_paren_symbols
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_parse_files_in_scope_ignores_paren_symbols
- name: test_parse_plan_file_extracts_owned_paths
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_parse_plan_file_extracts_owned_paths
- name: test_read_review_hints_absent
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_read_review_hints_absent
- name: test_review_hints_cw_owner_excludes_hotspot
  file: wave-orchestrator/tests/test_parse_mode_b.py
  symbol: test_review_hints_cw_owner_excludes_hotspot
- name: test_no_pause_marker_runs_normally
  file: wave-orchestrator/tests/test_pause.py
  symbol: test_no_pause_marker_runs_normally
- name: test_pause_marker_stops_before_next_wave
  file: wave-orchestrator/tests/test_pause.py
  symbol: test_pause_marker_stops_before_next_wave
- name: test_claim_input_auto_run_id
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_claim_input_auto_run_id
- name: test_claim_input_duplicate_raises
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_claim_input_duplicate_raises
- name: test_claim_input_missing_raises
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_claim_input_missing_raises
- name: test_claim_input_moves_dir
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_claim_input_moves_dir
- name: test_complete_run_missing_raises
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_complete_run_missing_raises
- name: test_complete_run_moves_to_processed
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_complete_run_moves_to_processed
- name: test_delete_run_from_processing
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_delete_run_from_processing
- name: test_delete_run_not_found
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_delete_run_not_found
- name: test_fail_run_missing_raises
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_fail_run_missing_raises
- name: test_fail_run_moves_to_failed
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_fail_run_moves_to_failed
- name: test_init_creates_dirs
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_init_creates_dirs
- name: test_init_idempotent
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_init_idempotent
- name: test_list_failed_after_fail
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_failed_after_fail
- name: test_list_input_empty
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_input_empty
- name: test_list_input_ignores_dotfiles
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_input_ignores_dotfiles
- name: test_list_input_returns_entries
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_input_returns_entries
- name: test_list_processed_after_complete
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_processed_after_complete
- name: test_list_processing_after_claim
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_list_processing_after_claim
- name: test_make_run_id_basic
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_make_run_id_basic
- name: test_make_run_id_max_slug_length
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_make_run_id_max_slug_length
- name: test_make_run_id_special_chars
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_make_run_id_special_chars
- name: test_make_run_id_uses_utc_by_default
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_make_run_id_uses_utc_by_default
- name: test_reset_run_retries_when_input_already_restored
  file: wave-orchestrator/tests/test_pipeline.py
  symbol: test_reset_run_retries_when_input_already_restored
- name: test_build_options_d1_gate
  file: wave-orchestrator/tests/test_pre0_interview.py
  symbol: test_build_options_d1_gate
- name: test_interview_writes_sheet
  file: wave-orchestrator/tests/test_pre0_interview.py
  symbol: test_interview_writes_sheet
- name: test_parse_decisions_table
  file: wave-orchestrator/tests/test_pre0_interview.py
  symbol: test_parse_decisions_table
- name: store
  file: wave-orchestrator/tests/test_profiles.py
  symbol: store
- name: test_delete_nonexistent_profile_raises
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_delete_nonexistent_profile_raises
- name: test_delete_profile
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_delete_profile
- name: test_empty_skills_and_scope_defaults
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_empty_skills_and_scope_defaults
- name: test_get_nonexistent_profile_raises
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_get_nonexistent_profile_raises
- name: test_list_profiles_empty
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_list_profiles_empty
- name: test_list_profiles_ordered
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_list_profiles_ordered
- name: test_profile_row_is_frozen
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_profile_row_is_frozen
- name: test_same_profile_reused_across_upserts
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_same_profile_reused_across_upserts
- name: test_scope_round_trip
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_scope_round_trip
- name: test_seed_default_profiles_idempotent
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_seed_default_profiles_idempotent
- name: test_seed_preserves_existing_customisation
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_seed_preserves_existing_customisation
- name: test_seed_returns_list
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_seed_returns_list
- name: test_seeded_profiles_not_created_twice
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_seeded_profiles_not_created_twice
- name: test_skills_round_trip
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_skills_round_trip
- name: test_upsert_and_get_profile
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_upsert_and_get_profile
- name: test_upsert_preserves_created_at
  file: wave-orchestrator/tests/test_profiles.py
  symbol: test_upsert_preserves_created_at
- name: test_claude_parse_result_quota_exhausted
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_claude_parse_result_quota_exhausted
- name: test_is_quota_exhausted_make_lint_not_quota
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_is_quota_exhausted_make_lint_not_quota
- name: test_is_quota_exhausted_session_limit
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_is_quota_exhausted_session_limit
- name: test_quota_message_first_line
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_quota_message_first_line
- name: test_run_streaming_stops_at_utilization
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_run_streaming_stops_at_utilization
- name: test_stream_quota_pause_at_99
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_stream_quota_pause_at_99
- name: test_stream_quota_pause_below_threshold
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_stream_quota_pause_below_threshold
- name: test_stream_quota_pause_rejected
  file: wave-orchestrator/tests/test_quota.py
  symbol: test_stream_quota_pause_rejected
- name: test_resolve_repo_root_from_env
  file: wave-orchestrator/tests/test_repo_root.py
  symbol: test_resolve_repo_root_from_env
- name: test_resolve_repo_root_walks_up_to_git
  file: wave-orchestrator/tests/test_repo_root.py
  symbol: test_resolve_repo_root_walks_up_to_git
- name: test_report_escalated_section_shows_evidence
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_escalated_section_shows_evidence
- name: test_report_lists_deferred_manual_prereqs
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_lists_deferred_manual_prereqs
- name: test_report_lists_phases_and_waves
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_lists_phases_and_waves
- name: test_report_no_escalation_when_clean
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_no_escalation_when_clean
- name: test_report_orchestrator_section_from_status_file
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_orchestrator_section_from_status_file
- name: test_report_pre0_approved_omits_gate_checklist_from_deferred
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_pre0_approved_omits_gate_checklist_from_deferred
- name: test_report_shows_current_wave
  file: wave-orchestrator/tests/test_report.py
  symbol: test_report_shows_current_wave
- name: test_sync_report_reads_ledger
  file: wave-orchestrator/tests/test_report.py
  symbol: test_sync_report_reads_ledger
- name: TestBackwardCompatibility
  file: wave-orchestrator/tests/test_role_column.py
  symbol: TestBackwardCompatibility
- name: TestInvalidRoleValue
  file: wave-orchestrator/tests/test_role_column.py
  symbol: TestInvalidRoleValue
- name: TestRoleColumnParsing
  file: wave-orchestrator/tests/test_role_column.py
  symbol: TestRoleColumnParsing
- name: TestRolePropagation
  file: wave-orchestrator/tests/test_role_column.py
  symbol: TestRolePropagation
- name: TestWaveSpecRoleDefault
  file: wave-orchestrator/tests/test_role_column.py
  symbol: TestWaveSpecRoleDefault
- name: test_resolve_dispatch_cli_overrides_persisted
  file: wave-orchestrator/tests/test_run_dispatch.py
  symbol: test_resolve_dispatch_cli_overrides_persisted
- name: test_resolve_dispatch_uses_persisted_when_cli_omits_backend
  file: wave-orchestrator/tests/test_run_dispatch.py
  symbol: test_resolve_dispatch_uses_persisted_when_cli_omits_backend
- name: test_resume_cli_extra_argv_from_persisted
  file: wave-orchestrator/tests/test_run_dispatch.py
  symbol: test_resume_cli_extra_argv_from_persisted
- name: test_write_and_read_dispatch_config
  file: wave-orchestrator/tests/test_run_dispatch.py
  symbol: test_write_and_read_dispatch_config
- name: TestNormalizationIdempotent
  file: wave-orchestrator/tests/test_scaffold.py
  symbol: TestNormalizationIdempotent
- name: TestNormalizationMap
  file: wave-orchestrator/tests/test_scaffold.py
  symbol: TestNormalizationMap
- name: TestScaffoldCommand
  file: wave-orchestrator/tests/test_scaffold.py
  symbol: TestScaffoldCommand
- name: TestScaffoldSubprocessFailure
  file: wave-orchestrator/tests/test_scaffold.py
  symbol: TestScaffoldSubprocessFailure
- name: client
  file: wave-orchestrator/tests/test_ui.py
  symbol: client
- name: client_authed
  file: wave-orchestrator/tests/test_ui.py
  symbol: client_authed
- name: test_dashboard_home_does_not_spawn_subprocess
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_does_not_spawn_subprocess
- name: test_dashboard_home_empty_state
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_empty_state
- name: test_dashboard_home_links_to_run_detail
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_links_to_run_detail
- name: test_dashboard_home_lists_seeded_run
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_lists_seeded_run
- name: test_dashboard_home_returns_200
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_returns_200
- name: test_dashboard_home_shows_backends
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_shows_backends
- name: test_dashboard_home_shows_profiles
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_shows_profiles
- name: test_dashboard_home_works_in_dev_mode
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_works_in_dev_mode
- name: test_dashboard_home_works_with_token
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_dashboard_home_works_with_token
- name: test_run_detail_404_unknown
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_404_unknown
- name: test_run_detail_approve_button_references_api
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_approve_button_references_api
- name: test_run_detail_buttons_use_htmx_post
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_buttons_use_htmx_post
- name: test_run_detail_does_not_spawn_subprocess
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_does_not_spawn_subprocess
- name: test_run_detail_embeds_sse_url
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_embeds_sse_url
- name: test_run_detail_has_back_link
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_has_back_link
- name: test_run_detail_multi_wave_rows
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_multi_wave_rows
- name: test_run_detail_pause_button_references_api
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_pause_button_references_api
- name: test_run_detail_resume_button_references_api
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_resume_button_references_api
- name: test_run_detail_returns_200
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_returns_200
- name: test_run_detail_shows_run_id
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_shows_run_id
- name: test_run_detail_shows_wave_node_ids
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_shows_wave_node_ids
- name: test_run_detail_shows_wave_phase
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_shows_wave_phase
- name: test_run_detail_token_injected_in_sse_url
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_token_injected_in_sse_url
- name: test_run_detail_uses_eventsource_js
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_uses_eventsource_js
- name: test_run_detail_wave_table_present
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_run_detail_wave_table_present
- name: test_sse_accepts_token_query_param
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_sse_accepts_token_query_param
- name: test_sse_rejects_wrong_token_query_param
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_sse_rejects_wrong_token_query_param
- name: test_static_htmx_is_served
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_static_htmx_is_served
- name: test_static_htmx_sse_is_served
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_static_htmx_sse_is_served
- name: test_w1_log_fragment_not_stub
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w1_log_fragment_not_stub
- name: test_w1_timeline_fragment_not_stub
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w1_timeline_fragment_not_stub
- name: test_w3_worktree_fragment_not_stub
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w3_worktree_fragment_not_stub
- name: test_w4_batch_timeline_fragment
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w4_batch_timeline_fragment
- name: test_w4_report_fragment_404_when_missing
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w4_report_fragment_404_when_missing
- name: test_w4_report_fragment_renders_markdown
  file: wave-orchestrator/tests/test_ui.py
  symbol: test_w4_report_fragment_renders_markdown
- name: tmp_rr
  file: wave-orchestrator/tests/test_ui.py
  symbol: tmp_rr
- name: test_parse_stream_usage_cursor_snake_case_variant
  file: wave-orchestrator/tests/test_usage.py
  symbol: test_parse_stream_usage_cursor_snake_case_variant
- name: test_parse_stream_usage_from_claude_result_event
  file: wave-orchestrator/tests/test_usage.py
  symbol: test_parse_stream_usage_from_claude_result_event
- name: test_parse_stream_usage_from_cursor_result_event
  file: wave-orchestrator/tests/test_usage.py
  symbol: test_parse_stream_usage_from_cursor_result_event
- name: test_parse_stream_usage_from_stamped_attempt_log_line
  file: wave-orchestrator/tests/test_usage.py
  symbol: test_parse_stream_usage_from_stamped_attempt_log_line
- name: test_parse_stream_usage_uses_last_result_event
  file: wave-orchestrator/tests/test_usage.py
  symbol: test_parse_stream_usage_uses_last_result_event
- name: test_brief_model_beats_adapter_model
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_brief_model_beats_adapter_model
- name: test_claude_adapter_instance_model_overrides_default_model
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_claude_adapter_instance_model_overrides_default_model
- name: test_claude_adapter_per_wave_model_overrides_default
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_claude_adapter_per_wave_model_overrides_default
- name: test_claude_adapter_uses_default_model_when_no_brief_model
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_claude_adapter_uses_default_model_when_no_brief_model
- name: test_count_assistant_event_non_assistant
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_count_assistant_event_non_assistant
- name: test_count_assistant_event_output_tokens
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_count_assistant_event_output_tokens
- name: test_count_assistant_event_with_tool_use
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_count_assistant_event_with_tool_use
- name: test_default_model_constant
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_default_model_constant
- name: test_no_progress_escalates_after_one_dispatch_on_git_worktree
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_no_progress_escalates_after_one_dispatch_on_git_worktree
- name: test_no_progress_guard_disabled_for_fake_worktree
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_no_progress_guard_disabled_for_fake_worktree
- name: test_progress_resets_no_progress_counter
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_progress_resets_no_progress_counter
- name: test_run_streaming_max_output_tokens_triggers_kill
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_run_streaming_max_output_tokens_triggers_kill
- name: test_run_streaming_max_tool_uses_triggers_kill
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_run_streaming_max_tool_uses_triggers_kill
- name: test_run_streaming_no_guard_when_limits_zero
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_run_streaming_no_guard_when_limits_zero
- name: test_runaway_guard_result_is_failed_not_quota
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_runaway_guard_result_is_failed_not_quota
- name: test_runaway_limits_from_env_defaults
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_runaway_limits_from_env_defaults
- name: test_runaway_limits_from_env_reads_values
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_runaway_limits_from_env_reads_values
- name: test_runaway_limits_invalid_values_default_to_zero
  file: wave-orchestrator/tests/test_w2_controls.py
  symbol: test_runaway_limits_invalid_values_default_to_zero
- name: lc
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: lc
- name: test_append_event_returns_incrementing_ids
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_append_event_returns_incrementing_ids
- name: test_append_event_stores_all_fields
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_append_event_stores_all_fields
- name: test_append_event_stores_metadata
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_append_event_stores_metadata
- name: test_engine_emits_dispatched_and_running_events
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_engine_emits_dispatched_and_running_events
- name: test_engine_emits_done_event_with_tokens
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_engine_emits_done_event_with_tokens
- name: test_engine_emits_failed_event_on_blocked
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_engine_emits_failed_event_on_blocked
- name: test_list_events_after_event_id_paging
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_list_events_after_event_id_paging
- name: test_list_events_after_last_returns_empty
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_list_events_after_last_returns_empty
- name: test_list_events_empty_run
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_list_events_empty_run
- name: test_list_events_filters_by_run_id
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_list_events_filters_by_run_id
- name: test_list_events_returns_all_for_run
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_list_events_returns_all_for_run
- name: test_on_event_throttle_many_same_action_lines
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_on_event_throttle_many_same_action_lines
- name: test_on_event_two_different_actions_two_calls
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_on_event_two_different_actions_two_calls
- name: test_run_streaming_on_event_called_on_action_change
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_run_streaming_on_event_called_on_action_change
- name: test_run_streaming_on_event_none_no_error
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_run_streaming_on_event_none_no_error
- name: test_run_streaming_on_event_not_called_on_same_action
  file: wave-orchestrator/tests/test_w3_events.py
  symbol: test_run_streaming_on_event_not_called_on_same_action
- name: test_build_graph_from_dir_prefers_v1
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_build_graph_from_dir_prefers_v1
- name: test_build_graph_v1_serial_batches
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_build_graph_v1_serial_batches
- name: test_manifest_deterministic
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_manifest_deterministic
- name: test_parse_execution_graph_rows
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_parse_execution_graph_rows
- name: test_validate_v1_missing_section
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_validate_v1_missing_section
- name: test_validate_v1_ok
  file: wave-orchestrator/tests/test_wave_plan_v1.py
  symbol: test_validate_v1_ok
- name: test_infer_active_task_longest_substring_match
  file: wave-orchestrator/tests/test_wave_task.py
  symbol: test_infer_active_task_longest_substring_match
- name: test_infer_active_task_no_match_non_running
  file: wave-orchestrator/tests/test_wave_task.py
  symbol: test_infer_active_task_no_match_non_running
- name: test_infer_active_task_running_fallback_first_unchecked
  file: wave-orchestrator/tests/test_wave_task.py
  symbol: test_infer_active_task_running_fallback_first_unchecked
- name: test_parse_wave_tasks_from_fixture
  file: wave-orchestrator/tests/test_wave_task.py
  symbol: test_parse_wave_tasks_from_fixture
- name: test_parse_wave_tasks_r1_m1_ids
  file: wave-orchestrator/tests/test_wave_task.py
  symbol: test_parse_wave_tasks_r1_m1_ids
- name: test_collect_worktree_status_from_git_repo
  file: wave-orchestrator/tests/test_worktree_status.py
  symbol: test_collect_worktree_status_from_git_repo
- name: test_poll_interval_is_five_seconds
  file: wave-orchestrator/tests/test_worktree_status.py
  symbol: test_poll_interval_is_five_seconds
- name: test_should_poll_worktree
  file: wave-orchestrator/tests/test_worktree_status.py
  symbol: test_should_poll_worktree
- name: test_allocate_and_cleanup
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_allocate_and_cleanup
- name: test_allocate_reuses_branch_after_cleanup
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_allocate_reuses_branch_after_cleanup
- name: test_allocate_reuses_existing_worktree
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_allocate_reuses_existing_worktree
- name: test_branch_name
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_branch_name
- name: test_checkpoint_message_deterministic
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_checkpoint_message_deterministic
- name: test_checkpoint_worktree_commits_changes
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_checkpoint_worktree_commits_changes
- name: test_detect_and_revert_scope_breach
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_detect_and_revert_scope_breach
- name: test_in_scope_change_not_flagged
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_in_scope_change_not_flagged
- name: test_owned_test_path_not_scope_breach
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_owned_test_path_not_scope_breach
- name: test_recover_worktree_commits_staged
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_recover_worktree_commits_staged
- name: test_stage_dispatch_context_stages_wave_slice
  file: wave-orchestrator/tests/test_worktrees.py
  symbol: test_stage_dispatch_context_stages_wave_slice
specs: []
personas: []
---
