...
fingerprint: sha256:996bc2caf5c6634b5fa79d512c6f5064b4f4daa7213ad266590b8ae099108443
related: []
sources:
- src/sevn/agent/**
...
Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Purpose.

## Public Interface

Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Public Interface.

## Data Model

Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Data Model.

## Internal Architecture

Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Internal Architecture.

## Behavior

Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Behavior.

## Failure Modes

Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Failure Modes.
...
Offline scaffold for Executor tier B — Spec (spec-14-executor-tier-b) — Test Strategy.
