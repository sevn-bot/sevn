...
| `proton-management` | [`../../src/sevn/data/bundled_skills/core/proton-management/SKILL.md`](../../src/sevn/data/bundled_skills/core/proton-management/SKILL.md) | Proton suite CLI (Python port) — Pass vaults/items with E2EE; Mail/Drive/Calendar/Contacts planned. |
