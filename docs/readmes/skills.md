...
| `discogs-shared` | [`../../src/sevn/data/bundled_skills/core/discogs-shared/SKILL.md`](../../src/sevn/data/bundled_skills/core/discogs-shared/SKILL.md) | Internal shared runtime for bundled Discogs skill scripts (_discogs_runtime.py). Not a model-facing research skill. |
