...
| `proton-management` | [`../../src/sevn/data/bundled_skills/core/proton-management/SKILL.md`](../../src/sevn/data/bundled_skills/core/proton-management/SKILL.md) | Proton suite CLI (Python port) — Pass, Mail, Drive, Calendar, Contacts. |
