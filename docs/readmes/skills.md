...
| `text-to-voice` | [`../../src/sevn/data/bundled_skills/core/text-to-voice/SKILL.md`](../../src/sevn/data/bundled_skills/core/text-to-voice/SKILL.md) | Unified local text-to-speech engines (Kokoro ONNX + Supertonic) backing the voice TTS pipeline (text_to_voice backend). Not a model-facing research skill. |
...
| `media_generation` | [`../../src/sevn/data/bundled_skills/core/media_generation/SKILL.md`](../../src/sevn/data/bundled_skills/core/media_generation/SKILL.md) | MiniMax media generation — 9 API paths, scene/style variables, 40+ prompt templates, 16 video agent templates, voice, music — via media_generator L2 specialist. |
