...
| `social_media_manager` | [`../../src/sevn/data/bundled_skills/core/social_media_manager/SKILL.md`](../../src/sevn/data/bundled_skills/core/social_media_manager/SKILL.md) | Monitor and interact with social media via TwexAPI, sevn CDP browser, and assigned social skills (x-use, facebook-use, linkedin-use). |
