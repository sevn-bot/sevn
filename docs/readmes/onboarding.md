...
This guide walks through operator setup step by step. Normative specs: `specs/22-onboarding.md`, `specs/23-cli.md`.

From specs/22-onboarding.md:
...
- [specs/22-onboarding.md](specs/22-onboarding.md)
- [specs/23-cli.md](specs/23-cli.md)
