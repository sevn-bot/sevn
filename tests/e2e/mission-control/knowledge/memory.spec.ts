// Mission Control — Memory tab (MC W3b).
// @mc-e2e-contract — G10 user-model panel (data-path: E4)
...
const THROWAWAY = `notes/mc-e2e-w3b-memory-${Date.now()}.md`;

test("memory — file editor new, save, delete", async ({ page }) => {
  ...
  await page.locator("#file-editor-content").fill("mc-e2e w3b memory probe");
